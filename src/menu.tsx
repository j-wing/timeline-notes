  ...
  render() {
    ...
    if (this.state.driveSignInState === DriveSignInState.SIGNED_IN) {
      driveMenuItems = [
        <Dropdown.Item
          key="signout"
          onClick={(e: React.MouseEvent<any>) => this.props.signOutHandler()}
        >
    ...
    return (
      <Dropdown>
        <Dropdown.Toggle id="menu">Menu</Dropdown.Toggle>
        <Dropdown.Menu>
          <Dropdown.Item
            onClick={(e: React.MouseEvent<any>) => this.props.newNoteHandler()}
          >
            New Note
          </Dropdown.Item>
          <Dropdown.Item
            onClick={(e: React.MouseEvent<any>) =>
              this.props.timestampLockToggleHandler()
            }
          >
